...
class GDNAttnBackend(MambaAttnBackendBase):
    ...
    def __init__(self, model_runner: ModelRunner):
        ...
        if model_runner.use_linear_compact_spec_cache():
            # Compact replay inputs are written by the Triton verify kernel.
            self.kernel_dispatcher.verify_kernel = self.kernel_dispatcher.triton_kernel
