        ...
        for name, loaded_weight in weights:
            ...
            for param_name, weight_name, shard_id in stacked_params_mapping:
                ...
                for mapping in expert_params_mapping:
                    ...
                    if is_expert_weight:
                        logger.info(
                            f"Skipping expert weight {name} not mapped to this rank."
                        )
                    ...
                    if name.endswith(".bias") and name not in params_dict:
                        logger.info(
                            f"Skipping bias weight {name} not found in params_dict."
                        )
                        continue
                    if name not in params_dict:
                        logger.info(f"Skipping weight {name} not found in params_dict.")
                        continue
