...
class ModelRunner:
    ...
    def initialize(self):
        ...
        # LoRA does not support deferring the initial weight load.
        ...
        self.maybe_start_post_load_weight_loading()
    ...
    def maybe_start_post_load_weight_loading(self):
        ...
        def get_weights():
            ...
            return loader._get_weights_iterator(
                DefaultModelLoader.Source.init_new(self.model_config, self.model)
            )
    ...
    def finalize_post_load_weights(self):
        if self._post_load_weight_future is None:
            return
        ...
        logger.info("Update weight begin. This can take up to several seconds.")
        success, message = self.weight_updater.update_weights_from_disk(
