...
LINEAR_ATTN_KERNEL_BACKEND_CHOICES = ["triton", "cutedsl", "flashinfer", "flashkda", "cula"]
...
class ServerArgs:
    ...
    reasoning_padding: A[
        Optional[str],
        "Output padding for reasoning models before generation, e.g. '<think>\\n'.",
    ] = None
    thinking_trigger: A[
        Optional[str],
        "Thinking mode trigger for hybrid models.",
    ] = None
    default_thinking: A[
        bool,
        "Use thinking mode by default for hybrid reasoning models.",
    ] = False
    ...
    allow_auto_output_truncate: A[
        bool,
        "Allow automatically truncating max_completion_tokens that exceed the maximum context length instead of returning an error.",
    ] = False
    ...
    enable_metrics: A[bool, "Enable log prometheus metrics."] = True
    ...
    mamba_extra_buffer_no_aligned: A[
        bool,
    ...
    def __post_init__(self):
        ...
        if envs.SGLANG_ASYNC_MODEL_MOUNT.get():
            # Preserve the configured model path while mounting weights asynchronously.
    ...
    def _handle_unified_memory_pool(self):
        ...
        # construction in KVCacheConfigurator._init_pools.
