...
class MooncakeKVManager(CommonKVManager):
    ...
    def __init__(
        ...
        self.is_sender_mode = self.disaggregation_mode == DisaggregationMode.PREFILL
        ...
        self.is_receiver_mode = self.disaggregation_mode == DisaggregationMode.DECODE
...
class MooncakeKVReceiver(CommonKVReceiver):
    ...
    def _register_kv_args(self):
        """Register KV args to bootstrap server"""
    ...
    def init(
        ...
        """Initialize receiver for KV transfer"""
        for bootstrap_info in self.bootstrap_infos:
            messages = [
