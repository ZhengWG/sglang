...
All speculative algorithms require `pp_size == 1`. See [PP, HiCache, and speculative decoding compatibility](./pp_hicache_spec_compatibility) for why, and which HiCache / DCP combinations survive.
