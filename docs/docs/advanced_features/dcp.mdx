...
The current scope is MLA L1/L2. L3, LMCache, HiSparse, non-MLA KV host pools, speculative decoding other than DSPARK, and PD decode are not supported in this combination. See [PP, HiCache, and speculative decoding compatibility](./pp_hicache_spec_compatibility) for the full matrix.
