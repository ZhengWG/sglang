...
class TestGoldenModelOverrides(_IsolatedPublish):
    ...
    def test_mamba_radix_cache_resolution_pass(self):
        ...
        # Bailing V2.5 keeps unaligned extra-buffer tracking, and Bailing V3
        # still routes through the mamba cache pass.
        self.assertEqual(
            _mamba_radix_cache_resolution(_view("BailingMoeV2_5ForCausalLM")),
            {
                "mamba_extra_buffer_no_aligned": True,
                "uses_mamba_radix_cache": True,
                "mamba_radix_cache_strategy": "extra_buffer",
            },
        )
