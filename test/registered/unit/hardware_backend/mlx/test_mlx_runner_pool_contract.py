...
The base ``ModelRunner.alloc_memory_pool`` runs ``KVCacheConfigurator._init_pools``
which asserts ``is_draft_worker``; the
    ...
    def test_stub_overrides_base_alloc_memory_pool(self):
        self.assertIn(
            ...
            msg=(
                ...
                "KVCacheConfigurator._init_pools, which asserts is_draft_worker "
                "and crashes every "
